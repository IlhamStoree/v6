...
echo ""
wget -q https://raw.githubusercontent.com/Bringas-tunnel/v6/main/tools.sh;chmod +x tools.sh;./tools.sh
rm tools.sh
clear
echo " "
clear
...
sleep 2
clear
wget https://raw.githubusercontent.com/Bringas-tunnel/v6/main/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
clear
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
...
sleep 2
clear
wget -q -O slow.sh https://raw.githubusercontent.com/Bringas-tunnel/v6/main/slow.sh && chmod +x slow.sh && ./slow.sh
clear
cat> /root/.profile << END
if [ "$BASH" ]; then
if [ -f ~/.bashrc ]; then
